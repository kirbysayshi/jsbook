...
//
// TODO: make drop down have a status area, so you don't get nervous about saving / dependencies always ticking along.
...
loadBook(bookFileName, function(err, res) {
  ...
  var book = Book.parse(res, bookFileName);
  book.executionContext = Book.createExecutionContext(book.__filename, book.__dirname);
